...
from .. import ruckusCore
from jinja2 import Environment, FileSystemLoader
import pkg_resources


classID = random.random()
class Fire(ruckusCore.module):
    ...
    def get_dims(self):
        self.context['w'] = int(self.app.game_engine.frontend.winright_dims[1] - 2)
        self.context['h'] = int(self.app.game_engine.frontend.winright_dims[0]-5)
        self.context['size'] = self.context['h'] * self.context['w']
        self.context['char'] = [" ", ",", "^", "~", "*", "r", "H", "$", "#", "@"]
